    ...
    <div class="mb-16 grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
      <div class="col-span-full lg:col-span-2">
        ...
        <div class="flex gap-4">
          <a href="https://www.instagram.com/clinicaveterinaria.vivet/" target="_blank" class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
          ...
          <a href="https://www.tiktok.com/@veterinaria.vivet?is_from_webapp=1&sender_device=pc" target="_blank" class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
            <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div>
        ...
        <nav class="flex flex-col gap-4">
          ...
          {{-- a href="{{ route('tenant.blog.index') }}" class="text-gray-500 hover:text-indigo-500">Blog</a> --}}<
