...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    <h2 class="text-2xl font-bold mb-6">Editar Mascota</h2>
    ...
    <form action="{{ route('pets.update', $pet->id) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="pet_name" id="pet_name"
                   value="{{ old('pet_name', $pet->pet_name) }}" required
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="color" id="color"
                       value="{{ old('color', $pet->color) }}" required
                       class="w-full border rounded px-3 py-2">
            </div>
        ...
        <div>
            ...
            <textarea name="notes" id="notes" rows="3"
                      class="w-full border rounded px-3 py-2">{{ old('notes', $pet->notes) }}</textarea>
        </div>
