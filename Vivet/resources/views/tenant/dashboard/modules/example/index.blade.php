                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="inline-flex items-start gap-x-3">
                                    <a href="#">
                                        <svg class="w-6 h-6 text-blue-600 dark:text-blue-500 hover:text-blue-800 transform hover:scale-110 transition duration-200"
                                    ...
                                    <a href="#">
                                        <svg class="w-6 h-6 text-red-600 dark:text-red-500 hover:text-red-800 transform hover:scale-110 transition duration-200"
