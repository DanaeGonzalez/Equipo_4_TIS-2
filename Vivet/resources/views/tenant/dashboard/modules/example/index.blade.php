                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="inline-flex items-start gap-x-3">
                                    <a href="#" data-tooltip-target="tooltip-edit" data-tooltip-placement="top">
                                        <svg class="w-6 h-6 text-gray-600 dark:text-white-500 hover:text-blue-800 transform hover:scale-110 transition duration-200"
                                    ...
                                    <a href="#" data-tooltip-target="tooltip-delete" data-tooltip-placement="top">
                                        <svg class="w-6 h-6 text-gray-600 dark:text-white-500 hover:text-red-800 transform hover:scale-110 transition duration-200"
                                    ...
                                    <a href="#" data-tooltip-target="tooltip-view" data-tooltip-placement="top">
                                        <svg class="w-6 h-6 text-gray-600 dark:text-white-500 hover:text-blue-800 transform hover:scale-110 transition duration-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
