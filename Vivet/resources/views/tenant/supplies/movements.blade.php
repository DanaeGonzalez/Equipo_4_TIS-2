...
<div class="max-w-3xl mx-auto">
    <h1 class="text-2xl font-bold mb-6">Movimientos de inventario: {{ $supply->name }}</h1>
    ...
    <div class="mt-6">
        <a style="background-color: var(--color-button-secondary);" class="bg-indigo-600 text-white px-4 py-2 rounded" href="{{ route('supplies.index') }}">← Volver a insumos</a>
    </div>
</div>
@endsection