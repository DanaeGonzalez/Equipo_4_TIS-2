        ...
        <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-4">
            ...
            <div> {{-- Selector para elegir el tipo de categoría que tienen los productos (enum)--}}
                ...
                <select id="category" name="category" class="w-full border-gray-300 rounded">
                    ...
                    <option value="Vacunas" {{ $product->category == 'Vacunas' ? 'selected' : '' }}>Vacuna</option>
                    <option value="Medicamentos" {{ $product->category == 'Medicamentos' ? 'selected' : '' }}>Medicamento</option>
                    <option value="Accesorios" {{ $product->category == 'Accesorios' ? 'selected' : '' }}>Accesorio</option>
                ...
                <div>
                    ...
                    <div id="toggleVaccines" class="flex items-center gap-2 ">
                        ...
                        {{--<label for="is_vaccine" class="inline-flex items-center mx-4">
                            ...
                            <input type="checkbox" name="is_vaccine" id="is_vaccine" class="mr-2" value="1" {{
                                old('is_vaccine', $product->is_vaccine) ? 'checked' : '' }}>
                            ¿Es una vacuna?
                        </label>--}}
                    </div>

                    <div id="vaccineinfo"
                        class="mt-4 {{ old('is_vaccine', $product->is_vaccine) ? '' : 'hidden' }} space-y-4 border-t pt-4">
                        <div>
