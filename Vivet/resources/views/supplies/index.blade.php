        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2 px-4 border-b space-x-2 flex justify-center items-center gap-4">
                    ...
                    <a href="{{ route('supplies.adjustStockForm', $supply) }}" class="text-blue-600 hover:underline flex items-center gap-1">
                    ...
                    <a href="{{ route('supplies.movements', $supply) }}" class="text-blue-600 hover:underline flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <form action="{{ route('supplies.destroy', $supply) }}" method="POST" class="flex items-center gap-1">
                        @csrf
                        @method('DELETE')
