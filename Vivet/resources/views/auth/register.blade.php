    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" method="POST"
                ...
                <div class="sm:col-span-2">
                    <label for="confirm-password" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Confirmar
                        Contraseña</label>
                ...
                <div class="flex items-center justify-between sm:col-span-2 mt-5">
                    <button type="submit"
                        class="inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Crear
                        cuenta</button>
                ...
                <p class="text text-gray-400 text-center">Si ya tienes tu cuenta, inicia sesión <a
                        href="{{ route('login') }}"
