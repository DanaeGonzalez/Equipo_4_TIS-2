...
<body>
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Entra con tu cuenta aquí</h2>

            <form class="mx-auto max-w-lg rounded-lg border" method="post" action="{{ route('login.submit') }}">
                @csrf
                <div class="flex flex-col gap-5 p-5 md:p-8">
                    <div>
                    ...
                    <button style="background-color: var(--color-button-secondary);" class="block rounded-lg px-10 py-4 text-center text-base font-semibold text-white outline-none transition duration-100 hover:opacity-90 focus-visible:ring active:opactity-80 md:text-base">Iniciar Sesión</button>
