...
class UserController extends Controller
{
    ...
    {
        $users = User::all();
        return view('tenant.dashboard.modules.users.index', compact('users'));
    }
    ...
    {
        $roles = Role::all();
        return view('tenant.dashboard.modules.users.create', compact('roles'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $roles = Role::all();
        return view('tenant.dashboard.modules.users.edit', compact('user', 'roles'));
    }
